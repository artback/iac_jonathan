...
variable "categories" {
  ...
  default = {
    ...
    orders     = "physical goods bought online being delivered by a courier: order confirmations, dispatch and delivery updates. NOT travel tickets"
    travel     = "any ticket or booking for a journey the recipient takes: train, flight, bus, ferry, hotel. Operators like SJ, SNCF, Ryanair, Air France belong here even when the mail quotes a booking reference that resembles a tracking code"
